...
execute if score $init_success tdh_el.temp matches 1 run function tdh_el:internal/load_values_from_entity
...
execute unless score $init_success tdh_el.temp matches 1 run function tdh_el:internal/init_fail_entity
